...
dict1={
    "file:/ts/inke.ts": [
        "del:var roomInfo: comm.RoomInfo | undefined = undefined",
        "add:var roomInfo: comm.RoomInfo = new comm.RoomInfo()",
        "del:roomInfo = new comm.RoomInfo()",
        "add:roomInfo.room_url = roomUrl",
        "del:roomInfo = undefined",
        "add:roomInfo.room_url = roomUrl"
    ],
    "file:/ts/zhanqi.ts": [
        "del:var roomInfo: comm.RoomInfo | undefined = undefined",
    ...
    "file:/ts/main.ts": [
        "add:var roomInfo = new comm.RoomInfo();",
        "add:let roomUrl",
        "del:let roomUrl",
        "add:roomInfo.room_url = roomUrl",
        "add:result = roomInfo",
        "del:console.log(roomUrl);",
        "add:roomInfo.room_url = roomUrl",
        "add:result = roomInfo",
        "add:roomInfo.room_url = roomUrl",
        "add:result = roomInfo"
    ...
    "commentID": [
        "d4755ff006769475923302b3d9223ffea5242aff"
    ],
    "file:/ts/qqgame.ts": [
        "del:var roomInfo: comm.RoomInfo | undefined = undefined",
        "add:var roomInfo: comm.RoomInfo = new comm.RoomInfo()",
    ...
    "file:/ts/quanmin.ts": [
        "del:var roomInfo: undefined | comm.RoomInfo = undefined",
        "add:var roomInfo: comm.RoomInfo = new comm.RoomInfo()",
        "del:roomInfo = new comm.RoomInfo()",
        "add:roomInfo.room_url = roomUrl",
        "del:roomInfo = undefined",
